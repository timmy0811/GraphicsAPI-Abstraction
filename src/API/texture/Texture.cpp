...
API::Texture::Texture* API::Texture::Texture::Create(const std::string& path, TextureFilter filter, const bool flipUV)
{
	...
	case API::Core::RendererAPI::API_ENUM::OpenGL:  return new OpenGL::Texture::Texture_OpenGL(path, filter, flipUV);
	}
