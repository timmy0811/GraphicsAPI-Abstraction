...
namespace API::Core {
	...
	public:
		...
		virtual int AddVertexData(const void* data, int size, int offset) = 0;
		virtual int AddVertexData(const void* data, int size) = 0;
		...
		static VertexBuffer* Create(size_t capacity);
